...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen w-full bg-background text-foreground overflow-x-hidden font-sans selection:bg-primary/30 pb-16 pt-20 sm:pb-20 sm:pt-24">
      {/* Background Layer */}
      <div 
      ...
      <header 
        className={cn(
          "fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-3 sm:px-6 h-20 sm:h-24 flex items-center justify-between",
      ...
      >
        ...
        <div className="flex items-center">
          <img 
            src={logoImage} 
            alt="VedaSolus" 
            className="h-32 sm:h-40 md:h-44 w-auto object-contain -ml-2 sm:-ml-4"
          />
        </div>
         ...
         <div className="flex items-center justify-between px-4 py-2 sm:py-3 max-w-7xl mx-auto">
           ...
           <div className="flex items-center gap-2">
              <a
                ...
                className="p-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 hover:bg-blue-500/20 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-slate-500/10 border border-slate-500/20 text-slate-300 hover:bg-slate-500/20 transition-colors"
